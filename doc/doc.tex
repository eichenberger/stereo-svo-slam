...
\begin{figure}[H]
  \centering
  \subfloat[]{\includegraphics[height=0.1\textheight]{img/optical_flow_intuitive_1.png}}\\
  \subfloat[]{\includegraphics[height=0.1\textheight]{img/optical_flow_intuitive_2.png}}\\
  \subfloat[]{\includegraphics[height=0.1\textheight]{img/optical_flow_intuitive_3.png}}
