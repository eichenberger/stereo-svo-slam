...
\begin{figure}[H]
  \centering
  \subfloat[Optical Flow with keyframes $I_{r1,2}$. New keypoint position g' found with optical flow]{\includegraphics[width=0.99\textwidth]{img/pose_estimation_opt_flow.png}}\\
  \subfloat[Pose $T_R$ refinement based on difference between keypoint position from sparse image alignemnt and optical flow]{\includegraphics[width=0.99\textwidth]{img/pose_estimation_refinement.png}}
