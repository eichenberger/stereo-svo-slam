...
\begin{table}[H]
  ...
  { impl & err x & err y & err z & err rx & err ry & err rz }\\
  \hline
  Our SVO & 0.577 & 1.230 & 1.503 & 6.521 & 12.698 & 14.772\\
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|c|c|c|c|c|}
    { impl & err x & err y & err z & err rx & err ry & err rz }\\
    \hline
    Our SVO & 0.265 & 0.447 & 0.722 & 1.528 & 2.704 & 3.21\\
...
\begin{figure}[H]
  \subfloat[Our implementation]{\includegraphics[width=0.5\textwidth]{img/blender_barcelona_our_diff.png}}
  \subfloat[ORB SLAM]{\includegraphics[width=0.5\textwidth]{img/blender_barcelona_orb_diff.png}}
