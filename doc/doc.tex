...
First tests on an ARM iMX8QM (Cortex A72) based system showed frame rates of around 10fps vs around 5fps for ORB SLAM. However, here no optimization or analysis is done yet. ARM NEON vectorization is used by the compiler but we didn't do any tracing of the library yet.\\
